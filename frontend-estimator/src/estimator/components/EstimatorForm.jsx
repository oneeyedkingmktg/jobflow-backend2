...
export default function EstimatorForm({
  ...
  const selectedBtnClass = useCustomStyles
    ? "rounded-lg border px-4 py-3 font-medium text-sm"
    : "rounded-lg border px-4 py-3 font-medium text-sm bg-orange-500 text-white border-orange-500";
  ...
  const unselectedBtnClass = useCustomStyles
    ? "rounded-lg border px-4 py-3 font-medium text-sm"
    : "rounded-lg border px-4 py-3 font-medium text-sm bg-white hover:bg-gray-50 border-gray-300";
